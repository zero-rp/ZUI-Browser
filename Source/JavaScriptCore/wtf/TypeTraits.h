...
namespace WTF {
    ...
    struct has_trivial_destructor
        ...
        : std::is_trivially_destructible<_Ty>::type
    ...
    struct has_trivial_constructor
        ...
        : std::is_trivially_default_constructible<_Ty>::type

    {	// determine whether _Ty has a trivial default constructor
    };
    // GCC's libstdc++ 20070724 and later supports C++ TR1 type_traits in the std namespace.
    // VC10 (VS2010) and later support C++ TR1 type_traits in the std::tr1 namespace.
    template<typename T> struct HasTrivialConstructor : public has_trivial_constructor<T> { };
    template<typename T> struct HasTrivialDestructor : public has_trivial_destructor<T> { };
