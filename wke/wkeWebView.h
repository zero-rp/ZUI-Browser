...
struct CWebViewHandler
{
	...
	wkeInitGraphicsCallback InitGraphicsCallback;
	void* InitGraphicsCallbackParam;

	wkeLoaderCallback LoaderCallback;
	void* LoaderCallbackParam;
...
public:
	...
	void onInitGraphics(wkeInitGraphicsCallback callback, void* callbackParam);
	void onLoader(wkeLoaderCallback callback, void* callbackParam);
