...
void wkeOnInitGraphics(wkeWebView* webView, wkeInitGraphicsCallback callback, void* callbackParam)
{
	webView->onInitGraphics(callback, callbackParam);
}

void wkeOnLoader(wkeWebView* webView, wkeLoaderCallback callback, void* callbackParam){
	webView->onLoader(callback, callbackParam);
}
