...
typedef void      (WKE_CALL *wkeInitGraphicsCallback)(wkeWebView* webView, void* param, const void* pixels, int cx, int cy);
WKE_API void        WKE_CALL wkeOnInitGraphics(wkeWebView* webView, wkeInitGraphicsCallback callback, void* callbackParam);

typedef bool      (WKE_CALL *wkeLoaderCallback)(wkeWebView* webView, void* param, const wkeString* url);
WKE_API void        WKE_CALL wkeOnLoader(wkeWebView* webView, wkeLoaderCallback callback, void* callbackParam);
